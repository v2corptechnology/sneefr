...
class SendDealRecapToSeller extends Job implements ShouldQueue
{
    ...
    public function handle(Mailer $mailer, Config $config)
    {
        ...
        $callback = function ($message) use ($seller, $data) {
            $message
                ...
                ->subject(trans('mail.deal_recap_seller.title'));
        };

        $mailer->send('emails.deal_recap_seller', $data, $callback);
    }
}
