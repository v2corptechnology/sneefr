...
return [
    ...
    'sidebar' => [
        ...
        'networks'                => "Network",
        'networks_title'          => ":name's network",
        'network_common'          => ":nb in common",
        'network_common_title'    => "People you have in common with :name",
        'network_following'       => "{0} No follower |[0,1] :nb follower |[2,Inf] :nb followers",
        'network_following_title' => "People who follow :name",
        'network_followed'        => "{0} 0 following |[0,1] :nb following |[2,Inf] :nb following",
        'network_followed_title'  => "People :name is following",
        'locations'               => "{0} No place of interest |[0,1] :nb place of interest |[2,Inf] :nb places of interest",
        'locations_title'         => ":name's places of interest",
        'location_title'          => ":place",
        'locations_empty'         => ":name has no place of interest",
    ...
    'networks' => [
        'page_title'           => ":name's network",
        'followed_head'        => ":name is following :nb people",
        'followed_empty_text'  => ":name is not following anyone",
        'following_head'       => ":nb people are following :name",
        'following_empty_text' => "Nobody is following :name, will you be the first?",
        'referrals_head'       => null,
        'referrals_empty_text' => null,
        'profile_title'        => "See :name's profile",
        'referrals'            => "in common",
        'followers'            => "followers",
        'followed'             => "following",
