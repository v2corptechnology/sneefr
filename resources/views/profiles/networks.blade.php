        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    @include('profiles.networks._followers_list', ['type' => "referrals",
                                                            'follows' => $referrals ])
                    @include('profiles.networks._followers_list', ['type' => "followers",
                                                            'follows' => $followingPersons ])
                    @include('profiles.networks._followers_list', ['type' => "followed",
                                                            'follows' => $followedPersons ])
